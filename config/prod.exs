...
config :sport_score, SportScore.Endpoint,
  ...
  url: [scheme: "https", host: "mysterious-fortress-51862.herokuapp.com", port: 443],
...
# start per endpoint:
#
#     config :sport_score, SportScore.Endpoint, server: true
#
# You will also need to set the application root to `.` in order
# for the new static assets to be served after a hot upgrade:
#
#     config :sport_score, SportScore.Endpoint, root: "."
